...
<html lang="en" data-layout="vertical" data-topbar="dark" data-sidebar="dark" data-sidebar-size="lg" data-bs-theme="light"
    data-sidebar-image="img-2" data-preloader="enable" data-layout-width="fluid" data-layout-position="fixed" data-layout-style="detached" data-sidebar-visibility="show">
                                ...
                                <button type="button" class="btn shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="d-flex align-items-center">
                                        ...
                                        <span class="text-start ms-xl-2">
                                            ...
                                            <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text fw-bold"><i><?php echo $this->session->userdata('emp_id'); ?> - <?php echo $this->session->userdata('hrms_position'); ?></i></span>
                                        </span>
                                    </span>
                                </button>
                        ...
                        <ul class="navbar-nav" id="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link menu-link <?php echo ($page == 'my_workloads') ? 'active' : ''; ?>"
                                    ...
                                    <iconify-icon icon="solar:clipboard-list-bold-duotone" class="fs-25"></iconify-icon>&nbsp;&nbsp;&nbsp;&nbsp; <span class="fs-12">My Workloads </span>
                                </a>
                            </li>
