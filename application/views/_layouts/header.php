...
?>
<!doctype html>
<html lang="en" data-layout="vertical" data-topbar="dark" data-sidebar="dark" data-sidebar-size="lg" data-bs-theme="light"
    data-sidebar-image="img-2" data-preloader="disable" data-layout-width="fluid" data-layout-position="fixed" data-layout-style="detached" data-sidebar-visibility="show">
                    ...
                    <div class="navbar-header">
                        ...
                        <div class="d-flex align-items-center" >
                                ...
                                <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                                    <button type="button"
                                        ...
                                        <iconify-icon icon="line-md:bell-filled-loop" class="fs-22"></iconify-icon><span
                                            class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger rcount">0</span>
                                    </button>
                                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                                            ...
                                            <div class="p-3">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-auto dropdown-tabs">
                                                        <span class="badge bg-light-subtle text-body fs-13 rcount"> </span>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-content position-relative">
                                            <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab"
                                                role="tabpanel" data-simplebar="" style="max-height: 400px;">
                                                <div class="pe-2"></div>
                            ...
                            <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                                    <button type="button"
                                        class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle shadow-none  bell"
                                        id="messages" data-bs-toggle="dropdown"
                                        data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
                                        <iconify-icon icon="line-md:chat-round-dots-twotone" class='fs-25'></iconify-icon><span class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger m-count">0</span>
                                    </button>
                                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                                        ...
                                        <div class="dropdown-head bg-primary bg-pattern rounded-top">
                                            <div class="p-3">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-auto dropdown-tabs">
                                                        <span class="badge bg-light-subtle text-body fs-13 m-count"> </span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="px-2 pt-2">
                                                <ul class="nav nav-tabs dropdown-tabs nav-tabs-custom"
                                                    data-dropdown-tabs="true" id="notificationItemsTab" role="tablist">
                                                    <li class="nav-item waves-effect waves-light">
                                                        <a class="nav-link active" data-bs-toggle="tab" href="#all-mes-tab"
                                                            role="tab" aria-selected="true">
                                                            Messages
                                                        </a>
                                                    </li>
                                        ...
                                        <div class="tab-content position-relative">
                                            <div class="tab-pane fade show active py-2 ps-2" id="all-mes-tab" role="tabpanel" data-simplebar="" style="max-height: 400px;">
                                                <div class="pe-2"></div>
                                                <div class="my-3 text-center view-all">
                                                    <!-- <a href="<?php echo base_url(); ?>chat" type="button" -->
                                                    <a href="#" type="button"
                                                        class="btn btn-soft-success waves-effect waves-light">View Messages
                                                        <i class="ri-arrow-right-line align-middle"></i></a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="ms-1 header-item d-none d-sm-flex">
                                <a href="<?php echo base_url('aboutus'); ?>" type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle light-dark-mode shadow-none">
                                <iconify-icon icon="mdi:about" class="fs-25"></iconify-icon>
                                </a>
                            </div>


                            <div class="dropdown ms-sm-3 header-item topbar-user">
                                <button type="button" class="btn shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="width: 280px">
                                    <span class="d-flex align-items-center">
                                        ...
                                        <span class="text-start ms-xl-2">
                                            <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"><?php echo ucwords(strtolower($this->session->userdata('name'))) ?></span>
                                            <span class="d-none d-xl-block ms-1 fs-11 user-name-sub-text fw-bold"><i><?php echo $this->session->userdata('emp_id'); ?> - <?php echo $this->session->userdata('hrms_position'); ?></i></span>
                                        </span>
                                    </span>
                                </button>
                                <div class="dropdown-menu dropdown-menu-end">
                                    <h6 class="dropdown-header">Welcome <?php echo ucwords(strtolower($this->session->userdata('name'))) ?>!</h6>
                    ...
                    <div class="container-fluid">
                        ...
                        <ul class="navbar-nav" id="navbar-nav">
                            ...
                            if ($this->session->userdata('is_admin') == 'Yes') {
                                ?>
                                <li class="nav-item">
                                    <a class="nav-link menu-link <?php echo in_array($page, ['kpi_view', 'module_view', 'add_user_view']) ? 'active' : ''; ?>"
                                        href="#sidebarLayouts" data-bs-toggle="collapse" role="button"
                                        aria-expanded="<?php echo in_array($page, ['kpi_view', 'module_view', 'add_user_view']) ? 'true' : 'false'; ?>"
                                        aria-controls="sidebarLayouts">
                                        <iconify-icon icon="solar:shield-bold-duotone" class="fs-25"></iconify-icon>&nbsp;&nbsp;&nbsp;&nbsp;
                                        <span class="fs-12">Admin Setup</span>
                                    </a>
                                    <div class="collapse menu-dropdown <?php echo in_array($page, ['kpi_view', 'module_view', 'add_user_view']) ? 'show' : ''; ?>"
                                        id="sidebarLayouts">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="<?php echo base_url('kpi_view'); ?>" class="nav-link fs-11 <?php echo ($page == 'kpi_view') ? 'active' : ''; ?>"> &nbsp;&nbsp;&nbsp;&nbsp;Create KPI
                                                </a>
                                                <!-- <a href="<?php echo base_url('module_view'); ?>" class="nav-link fs-11 <?php echo ($page == 'module_view') ? 'active' : ''; ?>"> &nbsp;&nbsp;&nbsp;&nbsp;Add Module | System
                                                </a> -->
                                                <a href="<?php echo base_url('add_user_view'); ?>" class="nav-link fs-11 <?php echo ($page == 'add_user_view') ? 'active' : ''; ?>"> &nbsp;&nbsp;&nbsp;&nbsp;Add Team Member
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link menu-link <?php echo ($page == 'request') ? 'active' : ''; ?>"
                                        href="<?php echo base_url('request'); ?>">
                                        <iconify-icon icon="solar:shield-check-bold-duotone"
                                            class="fs-25"></iconify-icon>&nbsp;&nbsp;&nbsp;&nbsp;
                                        <span class="fs-12">Request</span>
                                    </a>
                                </li>
                            ...
                            <?php
                            if ($this->session->userdata('position') == 'System Analyst') { ?>
                                <li class="nav-item">
                                    <a class="nav-link menu-link <?php echo ($page == 'module_view') ? 'active' : ''; ?>"
                                        ...
                                        <iconify-icon icon="pepicons-print:list-circle-filled"
                                            class="fs-25"></iconify-icon>&nbsp;&nbsp;&nbsp;&nbsp; <span
                                            class="fs-12">Add Module | System </span>
                                    </a>
                                </li>
                                <?php
                            }
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link menu-link <?php echo in_array($page, ['current_system', 'new_system']) ? 'active' : ''; ?>"
                                    href="#sidebarLayouts2" data-bs-toggle="collapse" role="button"
                                    aria-expanded="<?php echo in_array($page, ['current_system']) ? 'true' : 'false'; ?>"
                                    aria-controls="sidebarLayouts">
                                    <iconify-icon icon="solar:cpu-bolt-bold-duotone"
                                        class="fs-25"></iconify-icon>&nbsp;&nbsp;&nbsp;&nbsp; <span
                                        class="fs-12">Current | New System </span>
                                </a>

                                <div class="collapse menu-dropdown <?php echo in_array($page, ['current_system', 'new_system']) ? 'show' : ''; ?>"
                                    id="sidebarLayouts2">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="<?php echo base_url('current_system'); ?>"
                                                class="nav-link fs-11 <?php echo ($page == 'current_system') ? 'active' : ''; ?>">
                                                &nbsp;&nbsp;&nbsp;&nbsp;Current System | Module</a>
                                            <a href="<?php echo base_url('new_system'); ?>"
                                                class="nav-link fs-11 <?php echo ($page == 'new_system') ? 'active' : ''; ?>">
                                                &nbsp;&nbsp;&nbsp;&nbsp;New System | Module</a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="nav-item">
                                <a class="nav-link menu-link <?php echo ($page == 'deployment_view') ? 'active' : ''; ?>"
                                    ...
                                    <iconify-icon icon="solar:folder-check-bold-duotone"
                                        class="fs-25"></iconify-icon>&nbsp;&nbsp;&nbsp;&nbsp; <span
                                        class="fs-12">Deployment System </span>
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link menu-link <?php echo ($page == 'meeting_schedule') ? 'active' : ''; ?>"
                                    ...
                                    <iconify-icon icon="solar:checklist-minimalistic-bold-duotone"
                                        class="fs-25"></iconify-icon>&nbsp;&nbsp;&nbsp;&nbsp; <span
                                        class="fs-12">Meeting Scheduled </span>
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link menu-link <?php echo ($page == 'my_workloads') ? 'active' : ''; ?>"
                                    ...
                                    <iconify-icon icon="solar:clipboard-list-bold-duotone" class="fs-25"></iconify-icon>&nbsp;&nbsp;&nbsp;&nbsp; <span class="fs-12">My Workloads | Tasks </span>
                                </a>
                            </li>
